...
public class AggOrdersService {
	...
	private void updateInformationsByAggProduct(long customerId, String name, String familyName, String eventCode, String status,
			OrderProduct orderProduct, AggOrders aggOrders) {
